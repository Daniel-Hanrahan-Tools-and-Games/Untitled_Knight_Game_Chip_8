...
<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Untitled_Knight_Game_Chip_8">Repository Page</a>



On Screen Info:
skull = game over
o or monitor = start screen
triangle pointing left = getting game ready
arrows = direction prompts
x = action button prompts

Controls(Chip 8 Controls):
UP: Key 2
DOWN: Key 8
RIGHT: Key 6
ACTION / RETRY / START: Key 5 (The center button)
